...
public class AuditController {
	...
	@GetMapping(path="byDemandId/{id}")
	public List<Audit> getAuditByDemandId(@PathVariable int id) throws NoRecordFound{
		logger.info("Audit Controller - getAuditByDemandId()");
		List<Audit> auditList = new ArrayList<>();
		auditList = auditrepo.getAuditByDemandId(id);
		return auditList;
	}
